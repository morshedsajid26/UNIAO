...
const ResidentEvil = () => {
  return (
    ...
    <div className="left  bg-gradient-to-r from-[#18C5E1] from-0% via-[#8666EF] via-47% to-[#FB01FF] to-100% p-[2px] grid-cols-1 rounded-[25px] md:w-full w-[327px]">
        <div className='bg-[#1E2127] pt-[26px] md:pt-[75px] pb-6 md:pb-[50px] pl-5 md:pl-[63px] rounded-[25px] relative '>
            ...
            <h3 className='font-Inter text-white md:text-[68px] text-[26px] mt-3 md:mt-[17px]'>RE4 Remake DLC</h3>
    ...
    <div className="right   md:w-full w-[327px]">
